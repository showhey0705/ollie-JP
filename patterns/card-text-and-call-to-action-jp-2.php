<?php
/**
 * Title: Text and Call To Action Card JP 2
 * Slug: japonizm/card-text-and-call-to-action-jp-2
 * Description: 
...
<p class="has-primary-color has-text-color has-small-font-size" style="font-style:normal;font-weight:500">ジャポニズムを知ろう</p>
<!-- /wp:paragraph -->

<!-- wp:heading -->
<h2 class="wp-block-heading">違いはここだけ。変更されているのか否か</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Japonizmは次世代のWordPressクリエイターのためのブロックテーマです。 美しいパターンとテンプレートが組み込まれているので、爆速でサイトを立ち上げることができます。</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p style="font-style:normal;font-weight:600">「ジャポニスムとの仕事は、最初から最後まで素晴らしいものでした。」</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"500"}},"textColor":"secondary","fontSize":"x-small"} -->
<p class="has-secondary-color has-text-color has-x-small-font-size" style="font-style:normal;font-weight:500">1,420人のユーザーから5つ星の評価をいただいています</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<p class="has-base-color has-text-color has-medium-font-size" style="font-style:normal;font-weight:600">Japonizmを無料ダウンロード</p>
<!-- /wp:paragraph -->
...
<p class="has-base-color has-text-color">新しいWordPressサイトエディタとJaponizmブロックテーマで、フルカスタマイズ可能な美しいウェブサイトを簡単に作成できます。 誰にでもできます！ コーディングスキルは必要ありません。</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link has-primary-color has-base-background-color has-text-color has-background wp-element-button" href="https://japonizmwp.com">今すぐダウンロード</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
...
<p class="has-text-align-center has-primary-accent-color has-text-color has-link-color has-x-small-font-size" style="text-decoration:underline">WordPress.orgで詳細を確認する</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
